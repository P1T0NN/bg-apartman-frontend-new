...
One consequence worth stating plainly — a counter reflects rows that _exist_.
...
export const { counters, mutation, internalMutation } = defineCounters<DataModel>()((counter) => ({
...
| Field              | Purpose                                                            |
| ------------------ | ------------------------------------------------------------------ |
| _(first argument)_ | App table this counter follows                                     |
