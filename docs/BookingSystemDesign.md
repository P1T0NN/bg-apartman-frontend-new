...
| --------------------------------------------- | ---------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Booking creation form (`/book`)               | **Subscription**                               | Live read keyed on the slug — a host's edit or unpublish reflects while the guest looks. Availability is still validated in the mutation; the form never needs live dates. |
| Guest "my bookings" list                      | **Subscription** via DataTable                 | A live, paged view of the guest's own bookings — never page 1 as the full set.                                                                                             |
