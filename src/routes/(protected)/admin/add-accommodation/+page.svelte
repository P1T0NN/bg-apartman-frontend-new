<script lang="ts">
	...
	import AdminAddAccommodationForm from '@/components/pages/(protected)/admin/add-accommodation/admin-add-accommodation-form/admin-add-accommodation-form.svelte';
</script>
