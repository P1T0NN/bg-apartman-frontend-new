 ...
 */
export function apartmentToSearchListing(apartment: Doc<'apartments'>): SearchListing {
	const cover = apartment.images[apartment.coverImageIndex ?? 0] ?? apartment.images[0];
