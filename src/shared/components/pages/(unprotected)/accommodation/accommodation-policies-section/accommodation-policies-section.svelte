...
<section class="space-y-5">
	<h2 class="text-lg font-semibold tracking-tight">{m['AccommodationPage.AccommodationPoliciesSection.title']()}</h2>

	<div class="grid gap-8 sm:grid-cols-2">
		<div class="space-y-3">
			<h3 class="text-sm font-semibold">{m['AccommodationPage.AccommodationPoliciesSection.houseRules']()}</h3>
			<ul class="space-y-3">
		...
		<div class="space-y-3">
			<h3 class="text-sm font-semibold">{m['AccommodationPage.AccommodationPoliciesSection.bookingAndStay']()}</h3>
			<ul class="space-y-3">
